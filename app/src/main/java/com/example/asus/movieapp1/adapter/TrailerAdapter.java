...
public class TrailerAdapter extends RecyclerView.Adapter<TrailerAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(TrailerAdapter.MyViewHolder viewHolder, int i) {
        ...
        String thumbnail="https://img.youtube.com/vi/" +trailerList.get(i).getKey()+"/sddefault.jpg";
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(pos != RecyclerView.NO_POSITION){
                        ...
                        Toast.makeText(view.getContext(), "Opening Youtube", Toast.LENGTH_SHORT).show();
